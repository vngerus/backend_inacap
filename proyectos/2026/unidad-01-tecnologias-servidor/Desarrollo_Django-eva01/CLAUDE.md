...
Proyecto Django académico (INACAP, TI3V41 Unidad 1 — "Tecnologías del lado del servidor y desarrollo con Django"). Evaluado con escala de apreciación (`../../../material-referencial.md` → PDF de rúbrica), 12 indicadores, 4 niveles (Inicial/En desarrollo/Logrado/Destacado).
